        ...
        <div className="grid grid-cols-3 gap-[2vw]">
          ...
          <div className="flex flex-col items-center bg-stone-800 border-2 border-amber-600 rounded-lg">
            ...
            <input
              ...
              className="w-[6vw] text-[3vh] font-bold text-center bg-transparent border-amber-600 rounded text-amber-100 focus:outline-none focus:ring-2 focus:ring-amber-500"
            />
          </div>
