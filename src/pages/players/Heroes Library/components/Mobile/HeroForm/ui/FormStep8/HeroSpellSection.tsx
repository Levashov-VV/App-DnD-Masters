  ...
  return (
    <div className="flex flex-col gap-[1.5vh]">
      ...
      <button
        ...
        className="w-[98vw] self-start flex items-center gap-[0.5vw] bg-stone-800 hover:bg-stone-700 border-2 border-amber-600 text-amber-100 rounded-lg text-[1.6vh] font-bold transition-colors uppercase"
      >
      ...
      >
        <div className="flex flex-col gap-[0.4vh]">
          ...
          {/* Фильтр по уровням */}
          <div style={{ padding: '0.8vh 0' }} className="flex flex-wrap gap-[2vw]">
            {[null, 1, 2, 3, 4, 5, 6, 7, 8, 9].map((level) => (
              <button
                key={level ?? 'all'}
                type="button"
                onClick={() => setPreparedLevelFilter(level)}
                style={{ padding: '0.2vh 2vw' }}
                className={`text-[1.4vh] font-bold rounded border-2 transition-colors ${
