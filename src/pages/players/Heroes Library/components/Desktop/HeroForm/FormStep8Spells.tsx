  ...
  return (
    <div className="relative left-[0.5vw] top-[1vh] w-[74vw] flex flex-col gap-[1.5vh] uppercase max-h-[63vh] overflow-y-auto">
      ...
      <div className="grid grid-cols-3 gap-[2vw]">
        ...
        <div
          style={{ padding: '1vh 0.2vw' }}
          className="col-span-1 w-[25vw] border-2 border-amber-600 bg-stone-800 rounded-lg"
        >
          <div className="grid grid-cols-1 gap-[1vh]">
            ...
            <div className="flex flex-row justify-between items-center">
              ...
              >
                <div className="text-[2.5vh] font-bold text-amber-100">
            ...
            <div className="flex flex-row justify-between items-center">
              ...
              <div
                ...
                className="flex flex-col items-center justify-center border-2 border-amber-600 bg-stone-900 rounded-lg"
              >
                <div className="text-[2.5vh] font-bold text-amber-100">{spellSaveDC}</div>
              </div>
            </div>
            ...
            <div className="flex flex-row justify-between items-center">
              ...
              <div className="flex flex-col items-center justify-center border-2 border-amber-600 bg-stone-900 rounded-lg">
                <div
                  style={{ padding: '0.2vh 0.5vw' }}
                  className="text-[2.5vh] font-bold text-amber-100"
                >
        ...
        <div
          ...
          className="col-span-2 border-2 border-amber-600 bg-stone-800 rounded-lg"
        >
          <div style={{ marginBottom: '1vh' }} className="flex justify-between items-center">
            <h3 className="text-[2vh] font-bold text-amber-100">Ячейки заклинаний</h3>

            <div className="flex items-center gap-[1vw]">
              <div className="flex items-center gap-[0.3vw]">
                <label className="text-[1.4vh] text-amber-100/80">Актуальное:</label>
                <div className="w-[3vw] h-[2.5vh] bg-stone-900 border-2 border-amber-600/50 rounded flex items-center justify-center text-[1.6vh] font-bold text-amber-400">
              ...
              <div className="flex items-center gap-[0.3vw]">
                ...
                <div className="w-[3vw] h-[2.5vh] bg-stone-900 border-2 border-amber-600/50 rounded flex items-center justify-center text-[1.6vh] font-bold text-amber-100">
                  {displayTotals.max}
                </div>
              </div>
              ...
              <button
                ...
                style={{ padding: '0.2vh 0.5vw' }}
                className="h-[3vh] bg-green-600 hover:bg-green-500 border-2 border-green-600 text-stone-900 rounded-lg text-[1.4vh] font-bold transition-colors"
              >
                Долгий отдых
              </button>
              ...
              <button
                ...
                style={{ padding: '0.2vh 0.5vw' }}
                className="h-[3vh] bg-indigo-700 hover:bg-blue-600 border-2 border-blue-700 text-white rounded-lg text-[1.4vh] font-bold transition-colors"
              >
                Короткий отдых
              </button>
            </div>
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-[1.2vh] text-amber-100/80">
                      Доступно:{' '}
                  ...
                  <div className="flex items-center gap-[0.3vw]">
                    <label className="text-[1.2vh] text-amber-100/80">Максимум:</label>
                    <input
                      type="number"
                      min={0}
                      max={99}
                      ...
                      className="w-[3.5vw] h-[2.5vh] bg-stone-800 border-2 border-amber-600 rounded text-center text-[1.4vh] font-bold text-amber-100 focus:outline-none focus:border-amber-400"
                    />
                  </div>
                    ...
                    {Array.from({ length: slot.max }).map((_, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-[2.2vh] h-[2.2vh] rounded-full border-2 transition-all ${
                            isAvailable
      ...
      {showRestConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
          <div
            ...
            className="bg-stone-800 border-4 border-amber-600 rounded-xl w-[30vw]"
          >
