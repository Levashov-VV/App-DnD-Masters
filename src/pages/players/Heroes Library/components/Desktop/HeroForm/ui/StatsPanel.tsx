        ...
        <div className="grid grid-cols-3 gap-[1vw]">
          ...
          {activeConditions.size > 0 && (
            <motion.button
              ...
              className="w-[10vw] border-2 border-amber-600 bg-stone-800 hover:bg-stone-700 text-amber-100 font-bold text-[1.6vh] uppercase rounded-lg transition-colors flex items-center justify-center gap-[1vw]"
            >
              Полное излечение
            </motion.button>
          )}
              ...
              <div className="flex-1">
                <div className="relative left-[0.5vw] flex flex-col gap-[2vh]">
                  ...
                  <div className="w-[38vw]">
                    ...
                    <div
                      className={`flex items-center gap-[1vw] text-[2vh] font-bold ${
