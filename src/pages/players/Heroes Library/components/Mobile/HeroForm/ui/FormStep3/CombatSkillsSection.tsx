...
export function CombatSkillsSection({
  ...
  return (
    <div className="w-[47.5vw] col-span-2 border-2 border-amber-600 bg-stone-800 rounded-lg">
      <h3 className="text-[1.6vh] text-center font-bold text-amber-100">Боевые способности</h3>
      ...
      <div className="flex gap-[1vw]" style={{ paddingLeft: '0.2vw', paddingRight: '0.2vw' }}>
        <button
          ...
          className={`flex-1 rounded-lg text-[1.4vh] font-bold transition-colors ${
        ...
        <button
          ...
          className={`flex-1 rounded-lg text-[1.3vh] font-bold transition-colors ${
...
function SkillsList({
  ...
  return (
    <div className="w-[98%] max-h-[11.5vh] relative top-[1vh] left-[0.2vw] grid grid-cols-2 gap-[1vh] overflow-y-auto overflow-x-hidden">
      {combatSkills.map((ability, index) => (
        ...
        >
          <div className="flex items-center justify-between gap-[0.3vw] min-w-0">
            <span
              className="text-[1.5vh] text-amber-100 font-bold truncate flex-1 min-w-0"
              title={ability.name}
            >
              {ability.name}
            </span>
          ...
          <div className="flex flex-col text-[1.3vh] min-w-0 mt-[0.2vh]">
  ...
  return (
    <>
      <div className="h-[9.6vh] flex flex-col">
        ...
        >
          <div className="col-span-2 text-[1.4vh]">Название</div>
          <div className="text-[1.4vh]">Бонус</div>
          <div className="text-[1.4vh]">Урон</div>
        </div>
        <div
