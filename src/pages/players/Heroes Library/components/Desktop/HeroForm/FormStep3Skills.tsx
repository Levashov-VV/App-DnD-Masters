...
import { CombatSkillsSection } from '../../../components/Desktop/HeroForm/ui/FormStep3/CombatSkillsSection';
import { FeatsSection } from '../../../components/Desktop/HeroForm/ui/FormStep3/FeatsSection';
import { ProficienciesSection } from '../../../components/Desktop/HeroForm/ui/FormStep3/ProficienciesSection';
import { FeatsModal } from '../../../components/Desktop/HeroForm/ui/FormStep3/FeatsModal';
...
export function FormStep3Skills({ watch, setValue }: FormStep3SkillsProps) {
  ...
  return (
    <>
      <div className="relative left-[0.5vw] top-[1vh] w-[74vw] flex flex-col gap-[1vh] uppercase">
        <h2 className="text-[2.5vh] font-bold text-amber-100">Умения и владения</h2>

        <div className="grid grid-cols-3 gap-[2vw]">
          {/* КЛАССОВЫЕ УМЕНИЯ */}
          <div className="col-span-2 border-2 border-amber-600 bg-stone-800 rounded-lg">
...
Можно указать несколько умений, каждое с новой строки или через запятую."
              ...
              className="border-2 border-amber-600 h-[18vh]"
              defaultFontSize={14}
              minFontSize={10}
              maxFontSize={24}
            />
...
Можно указать несколько умений, каждое с новой строки или через запятую."
        ...
        <div className="h-[36vh] grid grid-cols-5 gap-[2vw]">
          {/* БОЕВЫЕ СПОСОБНОСТИ */}
          <CombatSkillsSection
