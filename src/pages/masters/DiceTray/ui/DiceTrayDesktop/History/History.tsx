...
export const History = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col gap-[0.4vh] overflow-auto text-[1.6vh]">
      ...
      {history.slice().map((roll: RollHistoryItem) => (
        <div
          key={roll.id}
          className="flex justify-between text-slate-200 bg-slate-800/50 rounded text-[1.2vh] hover:bg-slate-700/50 transition-colors"
        >
          <span>{roll.type}:</span>
