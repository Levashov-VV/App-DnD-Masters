...
// DESKTOP компонент
export function DescriptionAppDesktop() {
      ...
      >
        ...
        <div className="w-screen h-screen flex items-center relative z-20">
          <h3 className="text-[4.5vw] relative z-20 right-[20%]">
            ...
            <span
              ref={dndRef}
              className="inline-block text-[4.5vw]"
        ...
        <div className="w-screen h-screen flex items-center relative right-[5.5%]">
          ...
          <h3 className="text-[4.5vw]">
            ...
            <span
              ref={mechanicsTextRef}
              className="relative left-[0.2vw] inline-block transform-origin-left"
            >
              механиками
            </span>{' '}
            ...
            <span
              ref={doTextRef}
              className="inline-block bg-gradient-to-r from-red-400 via-orange-500 to-red-600 bg-clip-text text-transparent font-black text-[4.5vw] drop-shadow-[0_0_12px_rgba(239,68,68,0.7)] tracking-wide"
            >
              {doLetters.map((ch, i) => (
