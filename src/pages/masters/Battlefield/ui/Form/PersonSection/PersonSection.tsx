...
export function PersonSection() {
  ...
  useEffect(() => {
    const handleRemove = (e: Event) => {
      const event = e as CustomEvent<{ arrayName: 'characters' | 'enemies'; index: number }>;
      if (event.detail.arrayName === 'characters') {
  ...
  return (
    <section className="w-full flex flex-col gap-[2vh] min-h-[60vh]">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="flex items-center relative right-[1vw] justify-center gap-[4vw] text-amber-200 text-[2vh]">
      ...
      <div className="grid grid-cols-3 gap-6">
        {/* Игроки */}
        <div className="relative left-[1vw] bg-gradient-to-br from-blue-900/70 to-blue-800/70 rounded-2xl border-2 border-blue-500/50">
        ...
        {/* Враги */}
        <div className=" relative right-[1vw] bg-gradient-to-br from-red-900/70 to-red-800/70 p-6 rounded-2xl border-2 border-red-500/50">
        ...
        <div>
          ...
          <ul className="max-h-[40vh] overflow-y-auto">
            {characterFields.map((field, index) => (
              <UserItem key={field.id} index={index} arrayName="characters" />
            ))}
            {characterFields.length === 0 && (
