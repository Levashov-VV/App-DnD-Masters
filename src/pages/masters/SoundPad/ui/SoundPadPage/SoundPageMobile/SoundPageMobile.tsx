...
export const SoundPageMobile: React.FC = () => {
  ...
  if (!sceneSlug || !scenes || error) {
    return (
      <div className="flex flex-col justify-center items-center h-screen text-white gap-[2vh]">
        ...
        <Link to="/Master/soundpad" className="text-purple-400 underline">
  ...
  return (
    <div className="relative top-[15vh] flex flex-col items-center justify-center text-white">
      <header className="border-b w-screen border-white/10 flex items-center justify-center">
        <h1 className="text-[3.2vh] font-semibold">{name}</h1>
      </header>
      <Link
        to="/Master/soundpad"
      ...
      <main className="flex flex-col items-center justify-center gap-[35vh] flex-1">
        <div className="relative top-[2vh] w-[80vw]">
        ...
        <div className="relative bottom-[30vh] w-[95vw]">
