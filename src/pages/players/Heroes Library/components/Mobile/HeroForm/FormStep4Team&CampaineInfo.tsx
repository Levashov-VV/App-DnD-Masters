    ...
    <>
      <div className="relative left-[0.5vw] top-[1vh] w-[98vw] flex flex-col gap-[1vh] uppercase max-h-[63vh]">
        ...
        <div className="border-2 border-amber-600 bg-stone-800 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="w-[40vw] h-[5vh] bg-amber-600 hover:bg-amber-500 text-stone-900 rounded-lg text-[1.4vh] font-bold transition-colors flex items-center gap-[0.3vw]"
            >
              <svg
          ...
          <div className="relative">
            ...
            <div
              ...
              className="flex overflow-x-auto overflow-y-hidden gap-[1vw]scroll-smooth"
              style={{
                scrollbarWidth: 'thin',
            ...
            >
              {teamMembersData.teamMembers.length === 0 ? (
                <div className="w-full text-center text-amber-100/50 text-[1.5vh]">
        ...
        <div className="flex gap-[2vw]">
          <div className="h-[22.5vh] w-[50vw] col-span-2 border-2 border-amber-600 bg-stone-800 rounded-lg">
            <TextareaWithFontControl
              ...
              className="border-2 border-amber-600 h-[19vh]"
              defaultFontSize={14}
              minFontSize={10}
              maxFontSize={24}
            />
          ...
          <div className="h-[22.5vh] w-[50vw] border-2 border-amber-600 bg-stone-800 rounded-lg">
            <TextareaWithFontControl
              label="Внешность"
              value={appearance}
        ...
        <div className="grid grid-cols-2 gap-[2vw]">
          ...
          <div className="h-[20.5vh] col-span-1 border-2 border-amber-600 bg-stone-800 rounded-lg">
            <TextareaWithFontControl
