...
export function TeamMemberModal({ member, onSave, onClose }: TeamMemberModalProps) {
  ...
  return (
    <div className="fixed top-[15vh] inset-0 z-50 flex items-center justify-center bg-black/70">
      <div className="relative w-[60vw] h-[70vh] bg-stone-900 border-4 border-amber-600 rounded-2xl overflow-y-auto">
        {/* Заголовок */}
        <div className="flex items-center justify-between">
          <h2
            style={{ marginLeft: '0.5vw', paddingTop: '0.5vh' }}
            className="text-[3vh] font-bold text-amber-100 uppercase"
          >
        ...
        <div className="flex gap-[2vw]">
          <div className="flex flex-col items-center gap-[2vh]">
            {/* Фигурка */}
            <div className="w-[25vw] h-[50vh] overflow-hidden flex items-end justify-center">
              {raceFigure ? (
                <img
                  src={raceFigure}
                  alt="Фигурка расы"
                  className="w-[25vw] h-[40vh] drop-shadow-lg"
                />
              ) : (
                ''
              )}
          ...
          <div style={{ marginRight: '1vw' }} className="flex-1 flex flex-col gap-[2vh]">
            <div className="flex items-center gap-[1vw]">
              <div className="relative">
                <div className="w-[6vw] h-[6vw] rounded-full border-2 border-amber-600 bg-stone-800 overflow-hidden flex items-center justify-center">
                  {displayAvatar ? (
                    <img
                      src={displayAvatar}
                      alt="Аватар"
