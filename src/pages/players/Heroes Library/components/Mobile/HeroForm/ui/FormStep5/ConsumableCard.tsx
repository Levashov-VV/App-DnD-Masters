    ...
    >
      <div className="flex items-start justify-between gap-[1vw]">
        <div className="w-[20vw]">
          <div className="text-[1.1vh] font-bold text-amber-100 truncate">{consumable.name}</div>
          {consumable.description && (
            <div className="text-[1vh] text-amber-100/70 truncate">{consumable.description}</div>
          )}
        </div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-[0.1vw]">
            <button
              ...
              className="w-[6vw] h-[1.8vh] bg-red-600 hover:bg-red-500 rounded-4xl flex items-center justify-center transition-colors text-white font-bold text-[1.6vh]"
            >
              −
            </button>
            ...
            <button
              ...
              className="w-[6vw] h-[1.8vh] bg-green-600 hover:bg-green-500 flex items-center justify-center transition-colors text-amber-100 font-bold text-[1.6vh] rounded-4xl"
            >
              +
            </button>
          </div>
          <div className="flex flex-row gap-[3vw]">
            ...
            <button
              type="button"
              onClick={onDelete}
              className="w-[5vw] h-[2vh] bg-amber-600 hover:bg-amber-500 flex items-center justify-center transition-colors rounded-4xl"
            >
              <svg
                className="w-[1.3vh] h-[1.3vh] text-black"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
