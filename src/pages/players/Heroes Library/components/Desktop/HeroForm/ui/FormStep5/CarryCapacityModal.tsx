...
export function CarryCapacityModal({
  ...
  return (
    ...
    >
      <div
        className="relative top-[8vh] w-[75vw] max-h-[80vh] bg-stone-900 border-4 border-amber-600 rounded-2xl flex flex-col"
      ...
      >
        ...
        >
          <button
            type="button"
            onClick={onClose}
            className="bg-gray-700 hover:bg-gray-600 text-white w-[12vw] h-[4vh] rounded-lg font-bold transition-colors text-[1.6vh]"
          >
            Закрыть
          </button>
          <button
            type="button"
            onClick={handleApply}
            className="bg-amber-600 hover:bg-amber-500 text-stone-900 w-[12vw] h-[4vh] rounded-lg font-bold transition-colors text-[1.6vh]"
          >
            Применить
          </button>
        </div>
