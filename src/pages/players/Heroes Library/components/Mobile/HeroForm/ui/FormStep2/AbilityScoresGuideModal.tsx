...
export function AbilityScoresGuideModal({ isOpen, onClose }: AbilityScoresGuideModalProps) {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ padding: '1vw' }}
        className="relative bg-stone-800 border-2 border-amber-600 rounded-lg w-[100vw] max-h-[85vh] overflow-y-auto overflow-x-hidden shadow-2xl"
      >
        {/* Header */}
        ...
        <div className="flex flex-col gap-[1vh] max-h-[80vh]">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h4 className={`text-[1.6vh] font-bold ${ability.color}`}>
                        {ability.name}
                        <span className="text-amber-100/60 text-[1.2vh]">
        ...
        <div className="text-center">
          <button
            ...
            className="w-[40vw] bg-amber-600 hover:bg-amber-500 text-stone-900 font-bold rounded-lg transition-colors text-[2vh]"
          >
            Закрыть
          </button>
        </div>
