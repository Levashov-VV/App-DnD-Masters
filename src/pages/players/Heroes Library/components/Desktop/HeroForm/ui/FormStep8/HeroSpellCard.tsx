  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start gap-[0.5vw]">
        <span className="text-[1.4vh] font-bold text-amber-100 leading-tight">{spell.name}</span>
        <div className="flex flex-row gap-[1vw]">
          <span
            style={{ padding: '0.1vh 0.3vw' }}
            className={`shrink-0 text-[1vh] rounded border-2 ${
              isCantrip
          ...
          >
            <svg
              className="w-[1.8vh] h-[1.8vh] text-indigo-600"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
          ...
          {onRemove && (
            <button
              ...
              style={{ padding: '0.2vh 0.3vw' }}
              className="text-[1.1vh] font-bold bg-red-900/50 hover:bg-red-800/70 text-red-300 rounded-4xl transition-colors"
      ...
      {spell.isDamageSpell || spell.isConcentration || spell.isRitual ? (
        <div className="flex flex-row justify-between">
          <div style={{ margin: '0.3vh 0' }} className="flex flex-wrap gap-[0.3vw]">
